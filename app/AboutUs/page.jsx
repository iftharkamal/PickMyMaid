...
const AboutUS = () => {
  return (
    <div>
      ...
      <div className='pt-[80px] px-4 lg:px-[80px] flex flex-col gap-[15px] '>
      ...
      <div className='flex flex-col py-[50px] px-[4px] lg:px-[150px] gap-10 lg:gap-28'>
